class Admin::QuoteRequestsController < QuoteRequestsController
  ...
  def create
    ...
    respond_to do |format|
      if @quote_request.save
        format.html { redirect_to admin_@quote_request, notice: 'Quote request was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @quote_request.update(quote_request_params)
        format.html { redirect_to admin_@quote_request, notice: 'Quote request was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_quote_requests_url, notice: 'Quote request was successfully destroyed.' }
  ...
  private
    ...
    def quote_request_params
      params.require(:quote_request).permit(:name, :email, :mobile_number, :category)
    end
end
